          ...
          <div className=" row mx-auto my-5 d-none d-sm-block">
            <div className="card mb-3 p-1" style={{ maxWidth: "540px" }}>
              <div className="row g-0">
                <div className="col-md-4">
                  <img
                    src="https://res.cloudinary.com/dhqruwnj9/image/upload/v1679230508/grafico_pc_hyhphr.png"
                ...
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Consultar los partes nocturnos diarios y partes
                      quincenales del familiar
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="card mb-3 p-1" style={{ maxWidth: "540px" }}>
              <div className="row g-0">
                <div className="col-md-4">
                  <img
                    src="https://res.cloudinary.com/dhqruwnj9/image/upload/v1679230494/calendario_ftithk.png"
                    className="img-fluid rounded-start"
                    alt="..."
                  />
                </div>
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Solicitar un permiso de visita o un permiso de salida de
            ...
            <div className="card mb-3 p-1" style={{ maxWidth: "540px" }}>
              <div className="row g-0">
                <div className="col-md-4">
                  <img
                    src="https://res.cloudinary.com/dhqruwnj9/image/upload/v1679230696/email-g1fb2123c6_1280_dsvd3m.png"
                    className="img-fluid rounded-start"
                    alt="..."
                  />
                </div>
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Contactar con su familiar, asi como con el equípo médico.
                    </p>
                  </div>
                </div>
              </div>
