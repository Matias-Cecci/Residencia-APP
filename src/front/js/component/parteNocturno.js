          ...
          <div className="row g-0">
            ...
            <div className="col-md-8 p-3">
              ...
              <div className="input-group mb-3">
                <span className="input-group-text col-6" id="basic-addon1">
                  <i className="fa-solid fa-chart-line"></i> Azúcar:
                </span>
                <input
                  type="text"
                  className="form-control"
                  placeholder={parte.sugar_level}
                  aria-label="Username"
              ...
              <div className="input-group mb-3">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder={parte.oxygen_level}
                  aria-label="Username"
                  aria-describedby="basic-addon1"
                ></input>
              </div>
              <div className="input-group mb-3">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder={parte.cholesterol_level}
                  aria-label="Username"
                  aria-describedby="basic-addon1"
                ></input>
              </div>
              ...
              <div className="input-group mb-3">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder={parte.redbloods_level}
                  aria-label="Username"
                  aria-describedby="basic-addon1"
                ></input>
              </div>
              ...
              <div className="input-group mb-3">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder={parte.whitebloods_level}
                  aria-label="Username"
                  aria-describedby="basic-addon1"
                ></input>
              </div>
